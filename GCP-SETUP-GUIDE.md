...
- [ ] บัตรเครดิต/เดบิต ที่จ่าย **USD** ได้ (Google Cloud bill เป็น USD)
  - แนะนำบัตร KBank Debit Visa หรือ KTC ที่เปิดใช้งานต่างประเทศแล้ว
- [ ] หมายเลขโทรศัพท์มือถือสำหรับยืนยัน SMS
- [ ] Google account (ถ้ามี Gmail ใช้อันนั้นได้เลย)
- [ ] เวลาว่าง 1-2 ชั่วโมง ติดต่อกัน

---

## Step 1: สร้าง Google Cloud account (15 นาที)

- [ ] **1.1** เปิด <https://console.cloud.google.com>
- [ ] **1.2** Login ด้วย Google account
- [ ] **1.3** ยอมรับ Terms of Service (มี "Free trial $300" สำหรับ account ใหม่ — ใช้ได้ 90 วัน)
- [ ] **1.4** กด **Activate** เพื่อใส่บัตรเครดิต
...
- [ ] **2.1** มุมบนซ้าย คลิก dropdown ข้างคำว่า "Google Cloud" → "**New Project**"
- [ ] **2.2** ใส่ค่า:
  - Project name: `hibi-matcha-prod`
  - Project ID: `hibi-matcha-prod` (Google จะเติมเลข random ถ้าซ้ำ — ก็ใช้ตามนั้น)
  - Location: ปล่อยว่าง
- [ ] **2.3** กด **Create** → รอประมาณ 30 วินาที
- [ ] **2.4** เลือก project นี้จาก dropdown มุมบน
...
- [ ] **3.1** ไปที่ <https://console.cloud.google.com/apis/library>
- [ ] **3.2** ค้นหาและกด **Enable** ทีละตัว:
  - [ ] **Cloud SQL Admin API**
...
- [ ] **4.1** ไปที่ <https://console.cloud.google.com/sql/instances>
...
- [ ] **5.1** ไปที่ <https://console.cloud.google.com/storage/browser>
- [ ] **5.2** กด **Create**
- [ ] **5.3** ตั้งค่า:
...
- [ ] **6.1** ไปที่ <https://console.cloud.google.com/iam-admin/serviceaccounts>
...
- [ ] **7.1** ไปที่ <https://console.cloud.google.com/billing/budgets>
- [ ] **7.2** **Create Budget**
- [ ] **7.3** ตั้งค่า:
