...
export default function AdminReviewDetail() {
  ...
  const { data: review, isLoading, refetch } = trpc.reviews.detail.useQuery(
    { id: reviewId },
    { enabled: !!session && isAdmin && reviewId > 0 }
  );
  ...
  return (
    <AdminPageWrapper title="รายละเอียดรีวิว" backPath="/admin/reviews" loading={isLoading}>
            ...
            <Card className="border-0 shadow-sm">
              <CardContent className="p-4 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  {/* Fallback: show orderId if no specific fields */}
                  {!review.gfNumber && !review.shopeeOrderNumber && !review.linemanOrderNumber && review.deliveryApp !== "gpos" && (
                    <div>
